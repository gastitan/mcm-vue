  ...
  <div class="productFilter">
    <div id="prdfilter">
      ...
      <div class="form-group createProduct" v-if="loggedUser && loggedUser.isAdmin">
        <button class="btn buttonGreen-outline" @click="openCreateModal">Agregar Producto</button>
      </div>
      <div class="form-group">
        <label for="filterPrdCty">Por Categoría:</label>
        <select
          class="form-control"
          id="filterPrdCty"
      ...
      <div class="form-group">
        <label for="filterPrdSlr">Por Fabricante:</label>
        <select
          class="form-control"
          id="filterPrdSlr"

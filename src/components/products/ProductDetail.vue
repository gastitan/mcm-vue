  ...
  <div class="product-details">
    <div class="container">
        ...
        <div class="col-sm-4">
          <div class="product-image">
            ...
            <div class style="margin-top:15px">
              ...
              <button class="btn btn-primary" v-on:click="addToCart(product)">Agregar al carrito</button>
            </div>
          </div>
        </div>
        <div class="col-sm-8">
          <div class="product-detail">
            <h5 class="product-head">Detalles</h5>
      ...
      <nav aria-label="breadcrumb ">
        <ol class="breadcrumb">
          <li class="breadcrumb-item active" aria-current="page">Productos similares</li>
        </ol>
      </nav>
      <div class="row">
